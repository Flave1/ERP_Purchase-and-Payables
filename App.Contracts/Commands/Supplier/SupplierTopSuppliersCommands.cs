...
{
    public class UpdateSupplierTopSupplierCommand : IRequest<SupplierTopSupplierRegRespObj>
    {
    ...
    public class DeleteSupplierTopSupplierCommand : IRequest<DeleteRespObj>
    {
